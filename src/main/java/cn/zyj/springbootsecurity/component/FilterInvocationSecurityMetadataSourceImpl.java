package cn.zyj.springbootsecurity.component;

import cn.zyj.springbootsecurity.bean.Resource;
import cn.zyj.springbootsecurity.bean.Role;
import cn.zyj.springbootsecurity.service.ResourceService;
...
public class FilterInvocationSecurityMetadataSourceImpl implements FilterInvocationSecurityMetadataSource {
    ...
    public Collection<ConfigAttribute> getAttributes(Object o) throws IllegalArgumentException {
        ...
        List<Role> roles = resourceService.getRoles(resource.getResource_id());
        int size = roles.size();
